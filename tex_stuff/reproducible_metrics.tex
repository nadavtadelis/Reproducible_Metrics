...
\textcolor{BrickRed}{[Do I need to add more background on the proxy model?]}
...
\textcolor{BrickRed}{[Maybe only include continuous results here, and move discontinuous mapping to in appendix?]}
