...
\begin{scope}[xshift=8cm]
	...
	% Connected Segments
	\draw [color = black] (1,0) -- (1,5*0.0361) -- (2.5,5*0.0361) -- (2.5,5*0.0924) -- (5,5*0.0924) -- (5,5*0.0787) -- (6,5*0.0787);                 
\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
% horizontal axis
\draw[->] (-0.3,0) -- (12,0) node[anchor=north] {studytime};
...
\draw	(0,0) node[anchor=north] {0}
		...
		(0,2.5) node[anchor=east] {0.05}
		(0,5) node[anchor=east] {0.1};
...
% Functions
\draw[smooth, samples=200, color=black, domain=0:12] plot ({\x},{50*(0.022*\x - 0.001*\x*\x)}) 
        node at (5,3) {$f(x) = t$};
\draw[smooth, dotted, samples=200, color=blue, domain=0:12] plot ({\x},{50*(0.0268*\x - 0.0013*\x*\x)}) 
        node[above left] {$f(x) = t$ P};
\draw[smooth, dashed, samples=200, color=red, domain=0:12] plot ({\x},{50*(0.0128*\x - 0.0005*\x*\x)}) 
        node[below left] {$f(x) = t$ M};
%\draw[smooth, dashed, samples=200, color=red, domain=0:6] plot ({\x},{50*(0.0128*\x - 0.0005*\x*\x)}) 
%        node[right] {$f(x) = t$ M};                   
...
\begin{scope}[yshift=-8cm]
	...
	% Connected Segments
	\draw [color = black] (2,0) -- (2,5*0.0361) -- (5,5*0.0361) -- (5,5*0.0924) -- (10,5*0.0924) -- (10,5*0.0787) -- (15,5*0.0787);

	% Functions
	%\draw[smooth, samples=200, color=black, domain=0:6] plot ({\x},{50*(0.022*\x - 0.001*\x*\x)}); 
	%        \node[anchor=south] at (3,4.1) {$f(x) = t$};
	%\draw[smooth, dotted, samples=200, color=blue, domain=0:6] plot ({\x},{50*(0.0268*\x - 0.0013*\x*\x)}) 
	%        node[above left] {$f(x) = t$ P};
	%\draw[smooth, dashed, samples=200, color=red, domain=0:6] plot ({\x},{50*(0.0128*\x - 0.0005*\x*\x)}) 
	%       node[below left] {$f(x) = t$ M};
	%\draw[smooth, dashed, samples=200, color=red, domain=0:6] plot ({\x},{50*(0.0128*\x - 0.0005*\x*\x)}) 
