...
\textit{Note:}  & & & & \multicolumn{3}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\
\multicolumn{7}{l}{\textit{Studytime and Studytime$^2$ are instrumented. SE's for Q2SLS are bootstrapped. }} \\%R$^2$ and F stats have not been computed for Q2SLS.}} \\
\end{tabular} 
%}
\label{tab:Q2SLS}
\end{table}
