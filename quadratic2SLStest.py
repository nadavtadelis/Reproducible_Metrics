...
class Quadratic2SLSt(object):
    ...
    def fit(self, cov_type=None, n_iter=None):
        ...
        y, X, endog, Z = self.dependent, self.exog, self.endog, self.instruments
        ...
        model1B = sm.OLS(endog**2, pd.concat([endog_hat**2, X, Z], axis=1))
